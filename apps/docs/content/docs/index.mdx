...
<Cards className="grid-cols-2">
  ...
  <Card href="/docs/core-concepts/analyzers" title="Analyzer">
    Understand how Modbox analyzes code, providing insights into dependencies,
    imports, and module structure.
  </Card>
  <Card href="/docs/core-concepts/runtimes" title="Runtimes">
    Learn how Modbox executes code, managing the execution context and
    environment.
  </Card>
</Cards>
...
<Cards>
  <Card href="/docs/core-concepts" title="Understand Core Concepts">
    Dive deeper into Modbox's pipeline, plugins, and virtual file system.
  </Card>
  <Card href="/docs/plugins" title="Explore Official Plugins">
    Learn about all the powerful plugins Modbox offers and how to configure
    them.
  </Card>
</Cards>
